...
<div class="alert alert-info" style="display: none;"></div>
    ...
    <h3 class="text-muted">Продукт для вас</h3>
        <input class="orders_form" type="hidden"  data-id="" name="product_id" value="0"  id="send-val">
        <input class="orders_form" type="hidden"  data-id="" name="order_type" value="0" id="order_type" id="order_type">
        <input class="orders_form" type="text" name="tel" placeholder="Телефон"  id="phone"  style="width: 458px; height: 49px; border-radius: 5px; border: 2px solid lightgrey;">
        <input class="orders_form" type="text" name="first_name" id="first_name"  placeholder="Имя" style="width: 458px; height: 49px; border-radius: 5px; border: 2px solid lightgrey;" >
        <input class="orders_form" type="text" name="last_name" id="last_name" placeholder="Фамилия" style="width: 458px; height: 49px; border-radius: 5px; border: 2px solid lightgrey;">
        <p class="email_valid" style="display: none;">напишите ваш емаил</p>
        <input class="orders_form" type="text" name="email" id="email" placeholder="Email"  autocomplete="off" style="width: 458px; height: 49px; border-radius: 5px; border: 2px solid lightgrey;" >
